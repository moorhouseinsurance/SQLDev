     ...
     <screen>
         ...
         <controls>
             ...
             <control>
                 ...
                 <xsl:element name="value"><xsl:value-of select="number(boolean(ds:ENGINEERING='1' or ds:ENGINEERING='true'))" /></xsl:element>
                 <xsl:element name="dataType">b</xsl:element>
             </control>
             <control>
                 <xsl:attribute name="name">optManufacture</xsl:attribute>
                 <xsl:element name="value"><xsl:value-of select="number(boolean(ds:MANUFACTURE='1' or ds:MANUFACTURE='true'))" /></xsl:element>
                 <xsl:element name="dataType">b</xsl:element>
             </control>
         </controls>
     </screen>
