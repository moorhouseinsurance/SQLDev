...
-- 1. Turnover  
--============================================================
--SELECT * FROM [RM_PRODUCT] WHERE NAME LIKE '%Turnover%'
DECLARE
	 @SchemeName nvarchar(255) = 'NRT Price Forbes - Turnover'
	,@SchemeFileName  nvarchar(12) =  'POFTO001.wpd'
...
WHERE 
	[CG].[Name] = 'NRT Price Forbes - Turnover'
GO
...
FROM
	[RM_Scheme]
WHERE
	[Name] = 'NRT Price Forbes - Turnover'
GO
