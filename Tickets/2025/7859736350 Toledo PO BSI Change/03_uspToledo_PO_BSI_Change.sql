...
/****** Object:  StoredProcedure [dbo].[uspToledo_PO_BSI_Change]    Script Date: 17/12/2024 15:25:19 ******/
SET ANSI_NULLS ON
GO
...
-- Description: 7859736350 - Job stored procedure
-- =============================================
CREATE PROCEDURE [dbo].[uspToledo_PO_BSI_Change]

AS
/*

	EXECUTE [dbo].[uspToledo_PO_BSI_Change]
...
BEGIN
	...
	BEGIN
		...
		UPDATE
		[Transactor_Live].[dbo].[CUSTOMER_NOTES]
		SET
